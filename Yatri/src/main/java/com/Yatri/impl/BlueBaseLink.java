...
public class BlueBaseLink implements BaseLink{
	...
	public void addBaseToRover(Document doc) {
		...
		box.setAttribute("size","0.5 0.3 0.07");
		...
		boxA.setAttribute("size","0.5 0.3 0.07");
		
		Element material = doc.createElement("material");
		visual.appendChild(material);
		material.setAttribute("name","blue");
		...
		sphereA.setAttribute("radius","0.05");
	}
