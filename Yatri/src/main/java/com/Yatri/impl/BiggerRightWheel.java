...
public class BiggerRightWheel implements RightWheel{

	@Override
	public void addRightWheelToRover(Document doc) {

		Element root =doc.getDocumentElement();

		Element link = doc.createElement("link");
		root.appendChild(link);
		link.setAttribute("name", "link_right_wheel");
		...
		collision.setAttribute("name", "link_right_wheel_collision");		
		...
		cylinder.setAttribute("length", "0.05");
		cylinder.setAttribute("radius", "0.3");
		
		Element visual = doc.createElement("visual");
		link.appendChild(visual);
		visual.setAttribute("name", "link_right_wheel_visual");
		...
		cylinderA.setAttribute("length", "0.05");
		cylinderA.setAttribute("radius", "0.3");
		
		
		Element joint = doc.createElement("joint");
		root.appendChild(joint);
		joint.setAttribute("name", "joint_right_wheel");
		...
		child.setAttribute("link", "link_right_wheel");
